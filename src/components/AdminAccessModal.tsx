...
export const AdminAccessModal: React.FC<AdminAccessModalProps> = ({ isOpen, onClose, onAdminGranted }) => {
  ...
  return (
    <div className="q-modal-backdrop fixed inset-0 z-50 flex justify-center bg-slate-950/70 px-4 backdrop-blur-sm">
      <div className="w-full max-w-md max-h-[calc(100dvh-2rem)] overflow-y-auto rounded-3xl border border-white/15 bg-slate-950/95 p-6 shadow-2xl">
